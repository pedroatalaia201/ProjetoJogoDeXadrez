...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        private void colocarPecas()
        {
            ...
            colocarNovaPeca('e', 1, new Rei(tab, Cor.Branca, this));//autoreferência, nesse caso já estando na classe PartidaDeXadrez, 
            colocarNovaPeca('f', 1, new Bispo(tab, Cor.Branca));    //o uso de this serve para referenciar ela mesma.
